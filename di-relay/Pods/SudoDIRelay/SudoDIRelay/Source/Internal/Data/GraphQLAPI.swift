...
internal struct WriteToRelayInput: GraphQLMapConvertible {
  ...
  internal init(messageId: GraphQLID, connectionId: GraphQLID, cipherText: String, direction: Direction, utcTimestamp: String, nextToken: Optional<String?> = nil) {
    graphQLMap = ["messageId": messageId, "connectionId": connectionId, "cipherText": cipherText, "direction": direction, "utcTimestamp": utcTimestamp, "nextToken": nextToken]
  }
  ...
  internal var utcTimestamp: String {
    get {
      return graphQLMap["utcTimestamp"] as! String
    }
    set {
...
internal final class GetPublicKeyForRelayQuery: GraphQLQuery {
  internal static let operationString =
    "query GetPublicKeyForRelay($keyId: String!) {\n  getPublicKeyForRelay(keyId: $keyId) {\n    __typename\n    id\n    keyId\n    keyRingId\n    algorithm\n    publicKey\n    owner\n    version\n    createdAtEpochMs\n    updatedAtEpochMs\n  }\n}"
  ...
  internal struct Data: GraphQLSelectionSet {
    ...
    internal static let selections: [GraphQLSelection] = [
      GraphQLField("getPublicKeyForRelay", arguments: ["keyId": GraphQLVariable("keyId")], type: .object(GetPublicKeyForRelay.selections)),
    ]
...
internal final class GetPublicKeysForRelayQuery: GraphQLQuery {
  internal static let operationString =
    "query GetPublicKeysForRelay($limit: Int, $nextToken: String) {\n  getPublicKeysForRelay(limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      keyId\n      keyRingId\n      algorithm\n      publicKey\n      owner\n      version\n      createdAtEpochMs\n      updatedAtEpochMs\n    }\n    nextToken\n  }\n}"
  ...
  internal struct Data: GraphQLSelectionSet {
    ...
    internal static let selections: [GraphQLSelection] = [
      GraphQLField("getPublicKeysForRelay", arguments: ["limit": GraphQLVariable("limit"), "nextToken": GraphQLVariable("nextToken")], type: .nonNull(.object(GetPublicKeysForRelay.selections))),
    ]
...
internal final class GetKeyRingForRelayQuery: GraphQLQuery {
  internal static let operationString =
    "query GetKeyRingForRelay($keyRingId: String!, $limit: Int, $nextToken: String) {\n  getKeyRingForRelay(keyRingId: $keyRingId, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      keyId\n      keyRingId\n      algorithm\n      publicKey\n      owner\n      version\n      createdAtEpochMs\n      updatedAtEpochMs\n    }\n    nextToken\n  }\n}"
  ...
  internal struct Data: GraphQLSelectionSet {
    ...
    internal static let selections: [GraphQLSelection] = [
      GraphQLField("getKeyRingForRelay", arguments: ["keyRingId": GraphQLVariable("keyRingId"), "limit": GraphQLVariable("limit"), "nextToken": GraphQLVariable("nextToken")], type: .nonNull(.object(GetKeyRingForRelay.selections))),
    ]
...
internal final class GetMessagesQuery: GraphQLQuery {
  ...
  internal struct Data: GraphQLSelectionSet {
    ...
    internal struct GetMessage: GraphQLSelectionSet {
      internal static let possibleTypes = ["Packet"]
      ...
      internal static let selections: [GraphQLSelection] = [
        ...
        GraphQLField("utcTimestamp", type: .nonNull(.scalar(String.self))),
        GraphQLField("nextToken", type: .scalar(String.self)),
      ]
      ...
      internal init(messageId: GraphQLID, connectionId: GraphQLID, cipherText: String, direction: Direction, utcTimestamp: String, nextToken: String? = nil) {
        self.init(snapshot: ["__typename": "Packet", "messageId": messageId, "connectionId": connectionId, "cipherText": cipherText, "direction": direction, "utcTimestamp": utcTimestamp, "nextToken": nextToken])
      }
      ...
      internal var utcTimestamp: String {
        get {
          return snapshot["utcTimestamp"]! as! String
        }
        set {
...
internal final class SendInitMutation: GraphQLMutation {
  internal static let operationString =
    "mutation SendInit($input: WriteToRelayInput!) {\n  sendInit(input: $input) {\n    __typename\n    messageId\n    connectionId\n    cipherText\n    direction\n    utcTimestamp\n    nextToken\n  }\n}"
  ...
  internal struct Data: GraphQLSelectionSet {
    ...
    internal struct InternalFireOnPostBoxDeleted: GraphQLSelectionSet {
      ...
      internal struct RemainingMessage: GraphQLSelectionSet {
        internal static let possibleTypes = ["TableKey"]
        ...
        internal init(connectionId: GraphQLID, messageId: GraphQLID) {
          self.init(snapshot: ["__typename": "TableKey", "connectionId": connectionId, "messageId": messageId])
        }
