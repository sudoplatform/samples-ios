...
class WelcomeViewControllerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        instanceUnderTest = testUtility.storyBoard.resolveViewController(identifier: "welcome")
    ...
    func test_registerButtonTapped_fssoEnabled_willRegisterWithFsso() throws {
        ...
        XCTAssertEqual(instanceUnderTest.currentRegistrationMethod, .fsso)
    }
    ...
    func test_registerButtonTapped_TESTRegistrationEnabled_willRegisterWithTESTRegistration() throws {
       ...
       // testUtility.userClient.presentFederatedSignInUIResult = .success(resultTokens)
        instanceUnderTest.registerButtonTapped()
        waitForAsync()
        XCTAssertEqual(instanceUnderTest.currentRegistrationMethod, .test)
    }
    ...
    func test_registerButtonTapped_whenRegisteredButNotSignedIn_willInvokeSignInWithKeyOnUserClient() throws {
        testUtility.userClient.isSignedInReturn = false
    ...
    func test_registerButtonTapped_signInSuccessful_willSegueToPostboxView() throws {
        ...
        testUtility.userClient.signInWithKeyResult = .success(resultTokens)
